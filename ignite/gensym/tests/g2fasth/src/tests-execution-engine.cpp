...
public:
    ...
    void setup_test_track_scenario6() override
    {
        // C->B->A (all test cases pass)
    ...
    void setup_test_track_scenario7() override
    {
        // C->B->D  (some test cases pass)
    ...
    void setup_test_track_scenario8() override
    {
        // C->B=>D  (some test cases pass)
        auto &first_run = run(&TestExecutionScenario1::fourth_test, "D");
    ...
    void setup_test_track_scenario9() override
    {
        // C=>B=>D  (some test cases pass)
